    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden parchment-texture">
      ...
      <div className="relative container mx-auto px-4 py-20 text-center">
        ...
        <p className="max-w-2xl mx-auto text-lg text-muted-foreground font-body leading-relaxed mb-10">
          Plongez dans un univers où l'imagination n'a pas de limites. Rejoignez
          notre guilde de rôlistes, joueurs de société et collectionneurs de
          cartes pour vivre des aventures épiques !
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button
            size="lg"
            asChild
            className="btn-fantasy font-display text-lg px-8 text-primary-foreground"
          >
            <Link to="/inscription">
              Rejoindre l'Ordre
          ...
          <Button
            ...
            size="lg"
            asChild
            className="font-display text-lg px-8 border-primary/30 hover:bg-primary/10"
          >
  ...
  const activities = [
    {
      ...
      title: "Jeux de Rôle",
      description:
        "Incarnez des héros légendaires dans des aventures épiques. D&D, Pathfinder, Warhammer et bien plus encore.",
      color: "text-crimson",
    },
    {
      icon: Users,
      ...
      description:
        "Des classiques aux dernières nouveautés, découvrez notre ludothèque de plus de 200 jeux.",
    ...
    },
    {
      ...
      description:
        "Friday Night Magic chaque semaine. Tournois, drafts et commander pour tous les niveaux.",
      color: "text-primary",
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {activities.map((activity) => {
            ...
            return (
              ...
              >
                <div
                  className={`inline-flex p-3 rounded-lg bg-muted/50 mb-6 ${activity.color}`}
                >
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          ...
          <Button
            variant="outline"
            asChild
            className="mt-4 md:mt-0 font-display border-primary/30 hover:bg-primary/10"
          >
            <Link to="/calendrier">
            ...
            >
              ...
              <div className="flex items-center gap-4 w-full sm:w-auto">
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="font-display border-primary/30 hover:bg-primary/10"
                >
                  Détails
                </Button>
              </div>
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-80 lg:h-96 rounded-lg overflow-hidden card-fantasy">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2616.47!2d2.3608!3d49.0003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e669eb88311333%3A0x8b716d0a603e4652!2sLudoth%C3%A8que%20Bernard%20Tronchet!5e0!3m2!1sfr!2sfr!4v1704630000000"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="card-fantasy rounded-lg p-6">
                ...
                <p className="text-muted-foreground font-body">
                  Ludothèque de Saint-Brice-sous-Forêt
                  <br />
                  Val d'Oise, France
                </p>
              </div>
              <div className="card-fantasy rounded-lg p-6">
                ...
                <ul className="text-muted-foreground font-body space-y-1">
                  <li>Vendredi : 21h00 - Minuit (FNM)</li>
                  <li>Samedi : 21h00 - Minuit</li>
                  <li>Dimanche : 13h - 19h</li>
    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 text-center">
        ...
        <p className="text-lg text-muted-foreground font-body max-w-xl mx-auto mb-8">
          Que vous soyez un aventurier chevronné ou un jeune apprenti, notre
          guilde vous accueille à bras ouverts !
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button
            size="lg"
